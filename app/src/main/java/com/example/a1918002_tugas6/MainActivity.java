package com.example.a1918002_tugas6;
...
public class MainActivity extends AppCompatActivity {
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        btnOneTimeTask = findViewById(R.id.btn_proses);
        btnPeriodicTask = findViewById(R.id.btn_ubah);
        btnCancelPeriodicTask = findViewById(R.id.btn_cancel);
    ...
    private void startOneTimeTask(){
        ...
        Data data = new Data.Builder()
                .putString(MyWorker.EXTRA_CITY,spCity.getSelectedItem().toString())
                .build();
